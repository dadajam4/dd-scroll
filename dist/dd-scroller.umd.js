(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ddEv_umd = createCommonjsModule(function (module, exports) {
    (function (global, factory) {
    ...
    })(exports.ScrollerState || (exports.ScrollerState = {}));
    ...
    var Scroller = /** @class */ (function (_super) {
        ...
        function Scroller(setting) {
            ...
            _this._state = exports.ScrollerState.Pending;
        ...
        Object.defineProperty(Scroller.prototype, "isPending", {
            get: function () {
                return this._state === exports.ScrollerState.Pending;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Scroller.prototype, "isReady", {
            get: function () {
                return this._state === exports.ScrollerState.Ready;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Scroller.prototype, "isRunning", {
            get: function () {
                return this._state === exports.ScrollerState.Running;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Scroller.prototype, "isDestroyed", {
            get: function () {
                return this._state === exports.ScrollerState.Destroyed;
            },
            enumerable: true,
            configurable: true
        });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            this._setState(exports.ScrollerState.Running);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        Scroller.prototype.stop = function () {
            ...
            if (!this.isRunning)
                return;
            this._stopListeners();
            this._setState(exports.ScrollerState.Ready);
        };
        Scroller.prototype.destroy = function () {
            ...
            this._setState(exports.ScrollerState.Destroyed);
            this.offAll();
        };
        ...
        Scroller.States = exports.ScrollerState;
        return Scroller;
    }(ddEv_umd));
    ...
    exports.scrollToSide = scrollToSide;
    exports.scrollToElementSettingsDefaults = scrollToElementSettingsDefaults;
